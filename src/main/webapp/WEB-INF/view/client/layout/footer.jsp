                    ...
                    <div class="row g-4 d-flex justify-content-between">
                        <div class="col-lg-3">
                            <a href="#">
                                ...
                                <p class="text-secondary mb-0">thaihoc</p>
                            </a>
                        </div>
                        <div class="col-lg-3">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author: Bùi Thái Học</p>
                            <p>Email: thaihoc131005@gmail.com</p>
                            <p>Phone: +84344281310</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i
                                    class="fas fa-copyright text-light me-2"></i>thaihoc</a>, All right reserved.</span>
                    </div>
